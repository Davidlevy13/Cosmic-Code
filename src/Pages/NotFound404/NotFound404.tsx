...
const NotFound404 = () => {
  return (
    <div className="text-white p-15 px-2  flex flex-col items-center gap-4 text-center">
      ...
      <img src="/reponse-fausse.png" alt="logo-triste"  className="w-40 flex item-center mt-2" />
      <p className="text-xl text-wine-900 mb-6">Oups ! Cette page n'existe pas.</p>
      <Link
        to="/"
        className="mt-2 hover:text-orange-600 cursor-pointer text-white font-semibold px-2 py-2 rounded-lg transition"
      >
        Retour à l'accueil
      </Link>
    </div>
